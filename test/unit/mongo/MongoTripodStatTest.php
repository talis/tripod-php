...
class MongoTripodStatTest extends MongoTripodTestBase
{
    ...
    public function testStatsDSettersAndGetters()
    {
        ...
        $this->assertEquals(['class' => \Tripod\StatsD::class, 'config' => ['host' => 'foo.bar', 'port' => 9876, 'prefix' => '']], $stat->getConfig());
        ...
        $this->assertEquals(['class' => \Tripod\StatsD::class, 'config' => ['host' => 'bar.baz', 'port' => 4567, 'prefix' => 'FOO_BAR']], $stat->getConfig());
    }
